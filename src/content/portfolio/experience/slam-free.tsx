...
export const Experience$SLAM: FC = () => {
  return (
    <BlogCard
      ...
      <Stack spacing={2}>
        ...
        <Stack spacing={1}>
          <Typography color="textSecondary">
            ...
            mobile robot and surrounding objects within a controlled workspace.
          </Typography>
          <List>
            <ListItem>
              <ListItemText>
            ...
            <ListItem>
              <ListItemText>
                <Typography color="textSecondary">
                  Trained image recognition for changing workspace arrangements.
                </Typography>
              </ListItemText>
            </ListItem>
            <ListItem>
