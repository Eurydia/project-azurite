...
export const Award$SignMerit: FC = () => {
  return (
    <BlogCard
      ...
      <Stack spacing={2}>
        ...
        <Stack spacing={1}>
          <Typography color="textSecondary">
            ...
            (เครื่องหมายค่าแห่งคุณธรรม), an annual distinction recognizing exemplary
            conduct, diligence, selflessness, service, and sportsmanship, in
            2019.{" "}
