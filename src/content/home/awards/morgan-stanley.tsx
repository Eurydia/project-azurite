...
export const Award$MorganStanley: FC = () => {
  return (
    <BlogCard
    ...
    >
      <Stack spacing={2}>
        ...
        <Typography color="textSecondary">
          ...
          Information Foundation, funded through a donation from Morgan Stanley,
          in recognition of the paper "
          <b>
            Vision-based Localization Using Keypoint Detection for Toy-Following
            Mobile Robots
          </b>
          " presented at the 2025 Autumn ELTE Faculty of Informatics Scientific
